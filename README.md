...
<div align="center">
  <img src="terminal.svg?v=3" alt="About Me Terminal" width="450" />
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <img src="https://img.shields.io/badge/Nmap-0E83CD?style=flat-square&logoColor=white&labelColor=0D1117"/>
    ...
    <tr>
      ...
      <td>
        ...
        <img src="https://img.shields.io/badge/REST%20APIs-FF6C37?style=flat-square&logo=postman&logoColor=white&labelColor=0D1117"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <img src="https://img.shields.io/badge/VS%20Code-007ACC?style=flat-square&logo=visualstudiocode&logoColor=white&labelColor=0D1117"/>
      </td>
    </tr>
  </tbody>
</table>
...
class AlinshanAR:
    def __init__(self):
        ...
        self.currently_doing = [
            ...
            "📚 Deep-diving into Advanced Web Exploitation",
            "⚙️  Building custom security automation tools",
            "🏆 Solving CTF challenges & sharpening offensive skills",
            "🌐 Contributing to open-source security projects",
        ]
        self.ask_me_about  = ["Web Security", "Pentesting", "Python", "CTFs"]
        self.fun_fact      = "I think like an attacker to defend like a pro 🧠"

    def __str__(self):
        return "Security-first thinker | Code by day, hack (ethically) by night"
```
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white&labelColor=0D1117)](https://www.linkedin.com/in/alinshan-a-r-511a82307/)
